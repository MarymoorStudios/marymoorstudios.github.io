...
together with their parent's you get a computationally equivalent machine).  In practice, however, nested FSMs provide a
powerful abstraction for the separation of concerns between state machines, and for reusability.  For example: 
