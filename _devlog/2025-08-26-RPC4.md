...
Now, instead of having a game loop, the client would set its callback capability and just wait for the game to be over, relying on the implementation of the capability to handle game events:
