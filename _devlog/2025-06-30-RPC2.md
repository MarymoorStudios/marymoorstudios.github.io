...
progress bar couldn't be updated until **after** the load operation itself was complete.  Obviously we don't want
...
bounded by the target component that receives the messages.  It wouldn't make sense to require strong ordering for
