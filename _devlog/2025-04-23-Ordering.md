...
amount of testing has ever observed these rare interleavings.  This makes it very hard to test whether the use of locks
...
your programming environment.  In C# the Task Framework is built into both the Language Runtime and the language
